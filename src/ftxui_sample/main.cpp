...
// configuration step. It creates a namespace called `cpp_lab`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cpp_lab::cmake::project_name, cpp_lab::cmake::project_version) };
